...
import (
	...
	mgmt "github.com/verrazzano/rancher/pkg/apis/management.cattle.io/v3"
	v1 "github.com/verrazzano/rancher/pkg/apis/provisioning.cattle.io/v1"
	mgmtcluster "github.com/verrazzano/rancher/pkg/cluster"
	fleetconst "github.com/verrazzano/rancher/pkg/fleet"
	fleetcontrollers "github.com/verrazzano/rancher/pkg/generated/controllers/fleet.cattle.io/v1alpha1"
	mgmtcontrollers "github.com/verrazzano/rancher/pkg/generated/controllers/management.cattle.io/v3"
	rocontrollers "github.com/verrazzano/rancher/pkg/generated/controllers/provisioning.cattle.io/v1"
...
func (h *handler) createCluster(cluster *v1.Cluster, status v1.ClusterStatus) ([]runtime.Object, v1.ClusterStatus, error) {
	...
	if cluster.Spec.RKEConfig == nil {
		...
		privateRepoURL = mgmtcluster.GetPrivateRegistryURL(mgmtCluster.Spec.RancherKubernetesEngineConfig)
	} else {
