...
import (
	...
	corefakes "github.com/verrazzano/rancher/pkg/generated/norman/core/v1/fakes"
	v3fakes "github.com/verrazzano/rancher/pkg/generated/norman/management.cattle.io/v3/fakes"
...
func TestMigrateRKESecrets(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			assembler:  AssemblePrivateRegistryECRCredential,
			assembleVerifyFunc: func(t *testing.T, cluster *apimgmtv3.Cluster) {
