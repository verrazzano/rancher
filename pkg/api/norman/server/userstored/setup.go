...
import (
	...
	namespacecustom "github.com/verrazzano/rancher/pkg/api/norman/customization/namespace"
	"github.com/verrazzano/rancher/pkg/api/norman/customization/persistentvolumeclaim"
	sec "github.com/verrazzano/rancher/pkg/api/norman/customization/secret"
	"github.com/verrazzano/rancher/pkg/api/norman/customization/yaml"
	"github.com/verrazzano/rancher/pkg/api/norman/store/apiservice"
	"github.com/verrazzano/rancher/pkg/api/norman/store/cert"
	"github.com/verrazzano/rancher/pkg/api/norman/store/hpa"
	"github.com/verrazzano/rancher/pkg/api/norman/store/ingress"
	"github.com/verrazzano/rancher/pkg/api/norman/store/namespace"
	"github.com/verrazzano/rancher/pkg/api/norman/store/nocondition"
	"github.com/verrazzano/rancher/pkg/api/norman/store/pod"
	"github.com/verrazzano/rancher/pkg/api/norman/store/projectsetter"
	"github.com/verrazzano/rancher/pkg/api/norman/store/secret"
	"github.com/verrazzano/rancher/pkg/api/norman/store/service"
