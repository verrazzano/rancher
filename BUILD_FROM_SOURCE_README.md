...
For example, to find the relevant chart git commits for v2.7.1:
```
$ docker run --privileged -it --entrypoint=bash rancher/rancher:v2.7.1
...
The upstream tag this release is branched from is `v2.7.1`
