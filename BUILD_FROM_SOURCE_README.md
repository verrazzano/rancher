...
For example, to find the relevant chart git commits for v2.7.3:

The rancher charts commit below must be updated from the latest commit on the Verrazzano fork of the rancher charts BFS oracle/release/2.7.3 branch.
```
$ docker run --privileged -it --entrypoint=bash rancher/rancher:v2.7.3
...
56daab63cfc52ad362d99f9283a5f8594ec6c85f
...
The upstream tag this release is branched from the release tag `v2.7.3`

## BFS chart Updates for release `v2.7.3`

Verrazzano requires the BFS of the below image versions to be updated in the verrazzano-bom.json file to support rancher v2.7.3.
